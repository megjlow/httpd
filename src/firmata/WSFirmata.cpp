...
WSFirmataClass WSFirmata;

/* callback functions */
callbackFunction WSFirmataClass::currentAnalogCallback = (callbackFunction)NULL;
callbackFunction WSFirmataClass::currentDigitalCallback = (callbackFunction)NULL;
callbackFunction WSFirmataClass::currentPinModeCallback = (callbackFunction)NULL;
callbackFunction WSFirmataClass::currentPinValueCallback = (callbackFunction)NULL;
callbackFunction WSFirmataClass::currentReportAnalogCallback = (callbackFunction)NULL;
callbackFunction WSFirmataClass::currentReportDigitalCallback = (callbackFunction)NULL;
stringCallbackFunction WSFirmataClass::currentStringCallback = (stringCallbackFunction)NULL;
sysexCallbackFunction WSFirmataClass::currentSysexCallback = (sysexCallbackFunction)NULL;
systemCallbackFunction WSFirmataClass::currentSystemResetCallback = (systemCallbackFunction)NULL;
 ...
 */
void WSFirmataClass::sendValueAsTwo7bitBytes(int value)
{
 ...
 */
void WSFirmataClass::startSysex(void)
{
 ...
 */
void WSFirmataClass::endSysex(void)
{
 ...
 */
WSFirmataClass::WSFirmataClass()
:
  parser(WSFirmataParser(parserBuffer, MAX_DATA_BYTES))
{
  ...
  parser.attach(ANALOG_MESSAGE, (WSFirmataParser::callbackFunction)staticAnalogCallback, (void *)NULL);
  parser.attach(DIGITAL_MESSAGE, (WSFirmataParser::callbackFunction)staticDigitalCallback, (void *)NULL);
  parser.attach(REPORT_ANALOG, (WSFirmataParser::callbackFunction)staticReportAnalogCallback, (void *)NULL);
  parser.attach(REPORT_DIGITAL, (WSFirmataParser::callbackFunction)staticReportDigitalCallback, (void *)NULL);
  parser.attach(SET_PIN_MODE, (WSFirmataParser::callbackFunction)staticPinModeCallback, (void *)NULL);
  parser.attach(SET_DIGITAL_PIN_VALUE, (WSFirmataParser::callbackFunction)staticPinValueCallback, (void *)NULL);
  parser.attach(STRING_DATA, (WSFirmataParser::stringCallbackFunction)staticStringCallback, (void *)NULL);
  parser.attach(START_SYSEX, (WSFirmataParser::sysexCallbackFunction)staticSysexCallback, (void *)NULL);
  parser.attach(REPORT_FIRMWARE, (WSFirmataParser::versionCallbackFunction)staticReportFirmwareCallback, this);
  parser.attach(REPORT_VERSION, (WSFirmataParser::systemCallbackFunction)staticReportVersionCallback, this);
  parser.attach(SYSTEM_RESET, (WSFirmataParser::systemCallbackFunction)staticSystemResetCallback, (void *)NULL);
}
 ...
 */
void WSFirmataClass::begin(void)
{
  begin(57600);
}
 ...
 */
void WSFirmataClass::begin(long speed)
{
  Serial.begin(speed);
  blinkVersion();
  begin(Serial);
 ...
 */
void WSFirmataClass::begin(Stream &s)
{
  FirmataStream = &s;
  marshaller.begin(s);
 ...
 */
void WSFirmataClass::printVersion(void)
{
 ...
 */
void WSFirmataClass::blinkVersion(void)
{
 ...
 */
void WSFirmataClass::disableBlinkVersion()
{
 ...
 * firmware name.
 */
void WSFirmataClass::printFirmwareVersion(void)
{
 ...
 */
void WSFirmataClass::setFirmwareNameAndVersion(const char *name, byte major, byte minor)
{
 ...
 */
void WSFirmataClass::processInput(void)
{
 ...
 */
void WSFirmataClass::parse(byte inputData)
{
    parser.parse(inputData);
}
 ...
 */
boolean WSFirmataClass::isParsingMessage(void)
{
 ...
 */
void WSFirmataClass::sendAnalog(byte pin, int value)
{
 ...
 */
void WSFirmataClass::sendDigital(byte pin, int value)
{
  (void)pin;
  (void)value;
 ...
 */
void WSFirmataClass::sendDigitalPort(byte portNumber, int portData)
{
	Serial.println("sendDigitalPort");
 ...
 */
void WSFirmataClass::sendSysex(byte command, byte bytec, byte *bytev)
{
 ...
 */
void WSFirmataClass::sendString(byte command, const char *string)
{
 ...
 * @param string A pointer to the char string
 */
void WSFirmataClass::sendString(const char *string)
{
  marshaller.sendString(string);
}
 ...
 */
void WSFirmataClass::write(byte c)
{
  FirmataStream->write(c);
}

void WSFirmataClass::flush() {
 ...
 */
void WSFirmataClass::attach(uint8_t command, ::callbackFunction newFunction)
{
  switch (command) {
    case ANALOG_MESSAGE:
 ...
 */
void WSFirmataClass::attach(uint8_t command, systemCallbackFunction newFunction)
{
  switch (command) {
    case SYSTEM_RESET:
 ...
 */
void WSFirmataClass::attach(uint8_t command, stringCallbackFunction newFunction)
{
  switch (command) {
    case STRING_DATA:
 ...
 */
void WSFirmataClass::attach(uint8_t command, sysexCallbackFunction newFunction)
{
  (void)command;
 ...
 */
void WSFirmataClass::detach(uint8_t command)
{
  switch (command) {
    case SYSTEM_RESET:
 ...
 */
byte WSFirmataClass::getPinMode(byte pin)
{
 ...
 */
void WSFirmataClass::setPinMode(byte pin, byte config)
{
 ...
 */
int WSFirmataClass::getPinState(byte pin)
{
  return pinState[pin];
}
 ...
 */
void WSFirmataClass::setPinState(byte pin, int state)
{
  pinState[pin] = state;
}
 ...
 * this is too complicated for analogReceive, but maybe for Sysex?
 void WSFirmataClass::attachSysex(sysexFunction newFunction)
 {
 byte i;
 ...
 */
void WSFirmataClass::strobeBlinkPin(byte pin, int count, int onInterval, int offInterval)
{
  byte i;
  for (i = 0; i < count; i++) {
    delay(offInterval);
