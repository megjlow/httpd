 ...
 */
WSFirmataParser::WSFirmataParser(uint8_t * const dataBuffer, size_t dataBufferSize)
:
 ...
 */
void WSFirmataParser::parse(uint8_t inputData)
{
  uint8_t command;
 ...
 */
bool WSFirmataParser::isParsingMessage(void)
const
{
 ...
 * @param dataBufferSize The size of the external buffer
 */
int WSFirmataParser::setDataBufferOfSize(uint8_t * dataBuffer, size_t dataBufferSize)
{
    int result;
 ...
 */
void WSFirmataParser::attach(uint8_t command, callbackFunction newFunction, void * context)
{
  switch (command) {
    case ANALOG_MESSAGE:
 ...
 *       your callback function.
 */
void WSFirmataParser::attach(uint8_t command, versionCallbackFunction newFunction, void * context)
{
  switch (command) {
 ...
 *       your callback function.
 */
void WSFirmataParser::attach(uint8_t command, systemCallbackFunction newFunction, void * context)
{
  switch (command) {
    case REPORT_VERSION:
 ...
 *       your callback function.
 */
void WSFirmataParser::attach(uint8_t command, stringCallbackFunction newFunction, void * context)
{
  switch (command) {
    case STRING_DATA:
 ...
 *       your callback function.
 */
void WSFirmataParser::attach(uint8_t command, sysexCallbackFunction newFunction, void * context)
{
  (void)command;
 ...
 *       your callback function.
 */
void WSFirmataParser::attach(dataBufferOverflowCallbackFunction newFunction, void * context)
{
 ...
 */
void WSFirmataParser::detach(uint8_t command)
{
  switch (command) {
    case REPORT_FIRMWARE:
 ...
 */
void WSFirmataParser::detach(dataBufferOverflowCallbackFunction)
{
  currentDataBufferOverflowCallback = (dataBufferOverflowCallbackFunction)NULL;
  currentDataBufferOverflowCallbackContext = (void *)NULL;
}
 ...
 * @private
 */
bool WSFirmataParser::bufferDataAtPosition(const uint8_t data, const size_t pos)
{
 ...
 * @private
 */
size_t WSFirmataParser::decodeByteStream(size_t bytec, uint8_t * bytev) {
 ...
 * @private
 */
void WSFirmataParser::processSysexMessage(void)
{
 ...
 * @private
 */
void WSFirmataParser::systemReset(void)
{
  size_t i;
