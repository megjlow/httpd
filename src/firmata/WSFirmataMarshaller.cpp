 ...
 */
void WSFirmataMarshaller::reportAnalog(uint8_t pin, bool stream_enable)
const
{
 ...
 * @param stream_enable A zero value will disable the stream, a non-zero will enable the stream
 */
void WSFirmataMarshaller::reportDigitalPort(uint8_t portNumber, bool stream_enable)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
 ...
 */
void WSFirmataMarshaller::sendExtendedAnalog(uint8_t pin, size_t bytec, uint8_t * bytev)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
 ...
 */
void WSFirmataMarshaller::encodeByteStream (size_t bytec, uint8_t * bytev, size_t max_bytes)
const
{
 ...
 */
WSFirmataMarshaller::WSFirmataMarshaller()
:
 ...
 */
void WSFirmataMarshaller::begin(Stream &s)
{
  FirmataStream = &s;
}
 ...
 */
void WSFirmataMarshaller::end(void)
{
  FirmataStream = (Stream *)NULL;
}
 ...
 */
void WSFirmataMarshaller::queryFirmwareVersion(void)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
  FirmataStream->write(START_SYSEX);
 ...
 */
void WSFirmataMarshaller::queryVersion(void)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
 ...
 * @param pin The analog pin for which to request the value (limited to pins 0 - 15).
 */
void WSFirmataMarshaller::reportAnalogDisable(uint8_t pin)
const
{
 ...
 * @param pin The analog pin for which to request the value (limited to pins 0 - 15).
 */
void WSFirmataMarshaller::reportAnalogEnable(uint8_t pin)
const
{
 ...
 * of the Arduino digital pin numbering scheme. Port 0 = pins D0 - D7, port 1 = pins D8 - D15, etc.
 */
void WSFirmataMarshaller::reportDigitalPortDisable(uint8_t portNumber)
const
{
 ...
 * of the Arduino digital pin numbering scheme. Port 0 = pins D0 - D7, port 1 = pins D8 - D15, etc.
 */
void WSFirmataMarshaller::reportDigitalPortEnable(uint8_t portNumber)
const
{
 ...
 */
void WSFirmataMarshaller::sendAnalog(uint8_t pin, uint16_t value)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
 ...
 */
void WSFirmataMarshaller::sendAnalogMappingQuery(void)
const
{
 ...
 */
void WSFirmataMarshaller::sendCapabilityQuery(void)
const
{
 ...
 */
void WSFirmataMarshaller::sendDigital(uint8_t pin, uint8_t value)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
 ...
 */
void WSFirmataMarshaller::sendDigitalPort(uint8_t portNumber, uint16_t portData)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
 ...
 */
void WSFirmataMarshaller::sendFirmwareVersion(uint8_t major, uint8_t minor, size_t bytec, uint8_t *bytev)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
  size_t i;
 ...
 * @param minor The minor version number
 */
void WSFirmataMarshaller::sendVersion(uint8_t major, uint8_t minor)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
  FirmataStream->write(REPORT_VERSION);
 ...
 */
void WSFirmataMarshaller::sendPinMode(uint8_t pin, uint8_t config)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
 ...
 */
void WSFirmataMarshaller::sendPinStateQuery(uint8_t pin)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
  FirmataStream->write(START_SYSEX);
 ...
 * @param bytev A pointer to the array of data bytes to send in the message.
 */
void WSFirmataMarshaller::sendSysex(uint8_t command, size_t bytec, uint8_t *bytev)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
  size_t i;
 ...
 */
void WSFirmataMarshaller::sendString(const char *string)
const
{
 ...
 */
void WSFirmataMarshaller::setSamplingInterval(uint16_t interval_ms)
const
{
 ...
 */
void WSFirmataMarshaller::systemReset(void)
const
{
  if ( (Stream *)NULL == FirmataStream ) { return; }
