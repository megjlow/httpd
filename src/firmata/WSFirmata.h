...
#include "WSBoards.h"  /* Hardware Abstraction Layer + Wiring/Arduino */
#include "WSFirmataDefines.h"
...
class WSFirmataClass
{
  ...
  private:
    ...
    WSFirmataMarshaller marshaller;
    WSFirmataParser parser;
    Stream *FirmataStream = NULL;
    ...
    friend void WSFirmataMarshaller::encodeByteStream (size_t bytec, uint8_t * bytev, size_t max_bytes = 0) const;
    ...
    inline static void staticReportFirmwareCallback (void * context, size_t, size_t, const char *) { if ( context ) { ((WSFirmataClass *)context)->printFirmwareVersion(); } }
    inline static void staticReportVersionCallback (void * context) { if ( context ) { ((WSFirmataClass *)context)->printVersion(); } }
...
extern "C" {
  ...
  typedef firmata::WSFirmataClass::callbackFunction callbackFunction;
  typedef firmata::WSFirmataClass::systemCallbackFunction systemCallbackFunction;
  typedef firmata::WSFirmataClass::stringCallbackFunction stringCallbackFunction;
  typedef firmata::WSFirmataClass::sysexCallbackFunction sysexCallbackFunction;
}

extern firmata::WSFirmataClass WSFirmata;
